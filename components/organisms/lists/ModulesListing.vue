<template>
  <div class="d-container-content">
    <div
      class="w-full flex-col flex md:flex-row space-y-8 pt-1 pl-4 md:pl-0 md:space-y-0 justify-between md:border-b border-b-sky-dark mb-2"
    >
    ...
    <div class="lg:flex">
      ...
      <div
        class="w-full px-4 md:px-0 lg:w-4/5 min-w-0 min-h-0 lg:static lg:overflow-visible mt-8 grid md:grid-cols-2 gap-8 lg:ml-20 auto-rows-min"
      >
