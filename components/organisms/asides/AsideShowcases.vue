<template>
  <div class="sticky top-0 lg:left-0 pointer-events-auto lg:h-screen top-header lg:w-1/5 z-10 lg:z-0">
    <nav
      class="flex lg:flex-col justify-end lg:justify-start lg:max-w-sm w-full overflow-y-auto text-sm font-medium lg:h-[reset] h-(full-header) d-scrollbar d-px-container d-bg-header blur-12 lg:blur-0"
    >
