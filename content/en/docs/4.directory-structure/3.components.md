...
To access asynchronous data from an API in your components you can use Nuxt [`fetch()`](/___documentation___features/data-fetching#the-fetch-method).
...
::alert{type="next"}
See the chapter on [fetch()](/___documentation___features/data-fetching#the-fetch-method) for more details on how fetch works.
::
## Components Discovery

:prose-img{src="/img/___documentation___components.png"}
...
::alert{type="next"}
Learn more about the components module [in the component discovery documentation](/___documentation___features/component-discovery) and [in this announcement article](/tutorials/improve-your-developer-experience-with-nuxt-components).
::
...
::alert{type="next"}
See [the components property](/___documentation___configuration-glossary/configuration-components) for other methods of controlling component name.
::
