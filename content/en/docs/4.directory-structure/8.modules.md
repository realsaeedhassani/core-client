...
Discover our [list of modules](https://_example.com/modules) to supercharge your Nuxt project, created by the Nuxt team and community.

- 165+ Modules
- 105+ Maintainers

::alert{type="next"}
Check out [_example.com/modules](https://_example.com/modules)
::

![](/img/___documentation___modules.svg)
...
Please look into the [ModuleContainer](/___documentation___internals-glossary/internals-module-container) class docs for available methods.
...
Registered templates and plugins can leverage [lodash templates](https://lodash.com/___documentation___4.17.4#template) to conditionally change registered plugins output.
...
::alert{type="info"}
There are way more hooks and possibilities for modules. Please read the [Nuxt Internals](/___documentation___internals-glossary/internals) to find out more about the nuxt-internal API.
::
