...
::alert{type="info"}
Dynamic routes are also generated thanks to the [Nuxt Crawler](/___documentation___configuration-glossary/configuration-generate#crawler)
::
...
- Fallback to client-side rendering on 404, errors and redirects [see SPA fallback](/___documentation___concepts/static-site-generation#spa-fallback)
...
You might need server hosting if you want to render HTML on each request rather than in advance at generate-time, or if you need [serverMiddleware](/___documentation___configuration-glossary/configuration-servermiddleware). 
