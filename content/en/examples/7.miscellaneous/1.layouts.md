...
::alert{type="next"}
Learn more in the Concepts book in the [Views](/___documentation___concepts/views) chapter or in the Directory Structure book in the [Layouts](/___documentation___directory-structure/layouts) chapter.
::
