...
category: concepts
img: /___documentation___nuxt-lifecycle.svg
...
::alert{type="info"}
Check out the component chapter to see more info on [`<NuxtLink>`](/___documentation___features/nuxt-components#the-nuxtlink-component)
::
...
::alert{type="next"}
Check out the [Features book](/___documentation___features/rendering-modes)
::
