...
![Composition of a View in Nuxt](/img/___documentation___views.png)
...
::alert{type="next"}
See the [Directory Structure book](/___documentation___directory-structure/pages) to learn more about all the properties you can use on your page
::
...
::alert{type="next"}
Learn more about the [Nuxt component](/___documentation___features/nuxt-components) in the components chapter
::
