...
This lets you specify the [host and port](/___documentation___features/configuration#edit-host-and-port) for your Nuxt server instance.
...
You can find additional information on creating server keys and certificates on `localhost` on [certificates for localhost](https://letsencrypt.org/___documentation___certificates-for-localhost/) article.
...
Please refer to [Server-Timing MDN](https://developer.mozilla.org/en-US/___documentation___Web/HTTP/Headers/Server-Timing) for more details.
