...
This option is used by `nuxt generate` with [static target](/___documentation___features/deployment-targets#static-hosting) to avoid re-building when no tracked file has been changed.
...
- **Deprecated!**
- Use [build.html.minify](/___documentation___configuration-glossary/configuration-build#htmlminify) instead
