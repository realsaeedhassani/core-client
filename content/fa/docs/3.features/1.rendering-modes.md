...
See [deployment targets](/___documentation___features/deployment-targets) for more info on static and server hosting.
...
::alert{type="next"}
[The ssr property](/___documentation___configuration-glossary/configuration-ssr)
::
