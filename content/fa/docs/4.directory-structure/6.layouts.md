...
::alert{type="info"}
If you have [components set to true](/___documentation___directory-structure/components) then there is no need to add any import statements for your components.
::
