...
If you are upgrading to Nuxt v2.14 and want to use static hosting then you will need to add [`target:static`](/___documentation___features/deployment-targets#static-hosting) to your nuxt.config.js file in order for the generate command to work properly.
...
After this step instructions vary depending upon whether you are using Yarn or npm. _[Yarn](https://yarnpkg.com/en/___documentation___usage) is the preferred package manager for working with Nuxt as it is the development tool which tests have been written against._
