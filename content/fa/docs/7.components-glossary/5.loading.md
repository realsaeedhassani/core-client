...
You can disable or customize it globally through the [Configuration's loading option](/___documentation___configuration-glossary/configuration-loading), but also disable it for specific pages by setting the `loading` property to `false` :
