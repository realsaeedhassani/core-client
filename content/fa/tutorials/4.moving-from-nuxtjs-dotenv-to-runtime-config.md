...
```{}[.env]
BASE_URL=https://v2.genx.karbabar.ir
API_SECRET=1234
```
...
export default {
  publicRuntimeConfig: {
    baseURL: process.env.BASE_URL || 'https://v2.genx.karbabar.ir'
  }
}
```
...
export default {
  publicRuntimeConfig: {
    baseURL: process.env.NODE_ENV === 'production' ? 'https://v2.genx.karbabar.ir' : 'https://dev-v2.genx.karbabar.ir'
  }
}
```
...
export default {
  publicRuntimeConfig: {
    baseURL: 'https://v2.genx.karbabar.ir'
  },
  privateRuntimeConfig: {
    apiSecret: process.env.API_SECRET
  }
...
```bash{}[.env]
BASE_URL=/api
PUBLIC_URL=https://v2.genx.karbabar.ir
```
...
::list{type="success"}
- Use default values for runtimeConfig such as process.env.baseURL || 'https://v2.genx.karbabar.ir'
::
