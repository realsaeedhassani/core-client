...
```{}[.env]
BASE_URL=https://v2._example.com
API_SECRET=1234
```
...
export default {
  publicRuntimeConfig: {
    baseURL: process.env.NODE_ENV === 'production' ? 'https://v2._example.com' : 'https://dev-v2._example.com'
  }
}
```
...
```bash{}[.env]
BASE_URL=/api
PUBLIC_URL=https://v2._example.com
```
...
::list{type="success"}
- Use default values for runtimeConfig such as process.env.baseURL || 'https://v2._example.com'
::
